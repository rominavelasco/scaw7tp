...
<body>
	...
	<div class="encabezado"> 
			<ul class="navbar">
				...
				<li class="navbar2"><a class="navbar3" href="sesion.php">Login</a></li>
			</ul>
	</div>
	...
	<div class="container1">  
		...
		<div class="archivos">
			...
			<ul class="archivo">
				...
				?>
			    <!--echo"<a href='num.php?' ref=".$variable." target="_blank" > ".$variable." </a>"; -->
	...
	<h4>Comentarios</h4>
		<div class="comment">
			...
			<p>	Esqueleto tiene una serie de pequenias clases de utilidad que actuan como ayudantes de facil uso. A veces es mejor usar una clase de utilidad de crear una clase completamente nueva solo para flotar un elemento.</p>
			</div>
		</div>			
